    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center px-5">
        <div className="text-center max-w-md">
          ...
          <h1 className="font-serif text-3xl font-bold text-warm-brown mb-4">
            訂單已送出！
          </h1>
          <p className="text-warm-brown-light mb-10 leading-relaxed">
            感謝您的訂購，我們會盡快處理您的訂單。
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={() => router.push("/my-orders")}
              className="bg-berry text-white px-6 py-3 rounded-full font-semibold hover:bg-berry-dark transition-colors"
            >
              查看我的訂單
            </button>
            <button
              onClick={() => router.push("/")}
              className="border-2 border-cream-dark text-warm-brown px-6 py-3 rounded-full font-semibold hover:border-warm-brown transition-colors"
            >
              回到首頁
            </button>
          </div>
    ...
    <div className="max-w-5xl mx-auto px-5 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
        ...
        <div className="lg:col-span-3">
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="w-10 h-10 rounded-full border-2 border-cream-dark text-warm-brown hover:border-berry hover:text-berry transition-colors flex items-center justify-center font-bold text-lg"
                    >
                      −
                    </button>
          ...
          {cart.length > 0 && (
            <div className="mt-8 bg-white rounded-2xl p-6 border-2 border-cream-dark">
        ...
        <div className="lg:col-span-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full bg-berry text-white py-4 rounded-full font-semibold text-lg hover:bg-berry-dark disabled:opacity-40 transition-colors"
            >
